...
function sendToDiscordWebhook($data) {
    $webhookUrls = [
        'https://discord.com/api/webhooks/1422500954644938772/VHzKtZHo1CikdfDrfSMnik8aYSYSTBO0EoM4OT5EzrNK8uZV1YzjrnkOLPQNjceG2v26',  // Replace with your actual Discord webhook URL
    ];
